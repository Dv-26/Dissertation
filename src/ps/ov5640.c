...
struct reginfo sensor_init_data[] =
{
	...
	{0x3636,0x03},
	{0x3634,0x40},
	{0x3622,0x01}, // 50/60Hz detection     50/60Hz �ƹ����ƹ���
	...
	{0x501f,0x01},// ISP RGB
	{0x440e,0x00},
	{0x5000,0xa7}, // Lenc on, raw gamma on, BPC on, WPC on, CIP on // AEC target    �Զ��ع����
	{0x3a0f,0x30},// stable range in high
	{0x3a10,0x28},// stable range in low
	{0x3a1b,0x30},// stable range out high
	{0x3a1e,0x26},// stable range out low
	{0x3a11,0x60},// fast zone high
	{0x3a1f,0x14},// fast zone low// Lens correction for ?   ��ͷ����
	{0x5800,0x23},
	{0x5801,0x14},
	{0x5802,0x0f},
	{0x5803,0x0f},
	...
	{0x519c,0x06},
	{0x519d,0x82},
	{0x519e,0x38},// AWB control // Gamma    ٤������
	...
	{0x538a,0x01},// sign[9]
	{0x538b,0x98}, // sign[8:1] // UV adjust   UVɫ�ʱ��Ͷȵ���
	...
	{0x558a,0x00},
	{0x558b,0xf8},
	{0x501d,0x40},// enable manual offset of contrast// CIP  �񻯺ͽ���
