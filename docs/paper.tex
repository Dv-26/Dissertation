...
%   \bibitem{ref11}Shan J, Wang D, Yang E. High performance JPEG decoder based on FPGA[C]/2011 Asia Pacific conference on Postgraduate Research in Microelectronics \& Electonice. IEEE, 2011:57-60 \end{thebibliography}
\end{spacing}
\end{document}
